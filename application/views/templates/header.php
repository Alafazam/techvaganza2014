                    ...
                    <ul>
                        ...
                        <li class="icon icon-arrow-left">
                            ...
                            <div class="mp-level">
                                ...
                                <ul>
                                    <li class="icon">
                                        <a class="icon icon-phone icallajax" href="#events/codeShode">CodeShode</a>
                                        <!-- <div class="mp-level">
                                            <h2>CodeShode</h2>
                                            <a class="mp-back" href="#">back</a>
                                            <ul>
                                    ...
                                    <li class="icon">
                                        <a class="icon icon-tv icallajax" href="#events/creatives">Creatives</a>
                                        <!-- <div class="mp-level">
                                            <h2>Creatives</h2>
                                            <a class="mp-back" href="#">back</a>
                                            <ul>
                                    ...
                                    <li class="icon">
                                        <a class="icon icon-camera icallajax" href="#events/bob-the-builder">Bob-the-builder</a>
                                        <!-- <div class="mp-level">
                                    ...
                                    <li class="icon">
                                        <a class="icon icon-camera icallajax" href="#events/fixer_Elixer">Fixer Elixer</a>
                                        <!-- <div class="mp-level">
                                            <h2>Fixer Elixer</h2>
                                            <a class="mp-back" href="#">back</a>
                                            <ul>
                                    ...
                                    <li class="icon">
                                        <a class="icon icon-camera icallajax" href="#events/robonoids">Robonoids</a>
                                        <!-- <div class="mp-level">
                                            <h2>Robonoids</h2>
                                            <a class="mp-back" href="#">back</a>
                                            <ul>
