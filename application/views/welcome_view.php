                            <div id='top-sticky'>
                                ...
                                <div>
									...
									?>  
										...
										<script id="runscript" src="/js/hexaflip.js">
...
var settings = {
    ...
    tvza = new HexaFlip(document.getElementById('tvza-timer'),makeObject("TECHVAGANZA"),settings);
    var c = true;
    var x=0;
    tvza.setValue(hflp);
...
document.addEventListener('DOMContentLoaded', function(){
    ...
    window.setInterval(function(){                
        ...
        var diffMin = Math.floor(timeDiff / (1000 * 60 ))%60;            
        var diffSec = Math.floor(timeDiff / (1000))%60;
